using Apps.SitecoreGraphQl.Connections;
...
public class ConnectionValidatorTests : TestBase
{
    ...
    public async Task ValidateConnection_ValidData_ShouldBeSuccessful()
    {
        ...
        var result = await validator.ValidateConnection(CredentialsProviders, CancellationToken.None);
    ...
    {
        var validator = new ConnectionValidator();
        var newCredentials = CredentialsProviders
